			...
			<ul class="navbar-nav">
				<c:choose>
					...
					<c:otherwise>
						...
						<li class="nav-item dropdown"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> 스토리 </a>

							<ul class="dropdown-menu" role="menu">
								<li class="nav-item"><a href="/story/home" class="dropdown-item"> <span class="text-secondary"> <i class="fas fa-cloud"></i>스토리
											홈
									</span>
								</a></li>

								<li class="nav-item"><a href="/story/upload" class="dropdown-item"> <span class="text-secondary"> <i class="fas fa-cloud"></i>스토리
											업로드
									</span>
								</a></li>
